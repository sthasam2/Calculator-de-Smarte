...
namespace ScienCalc {
		...
		private: System::Windows::Forms::Button^ buttonPwr;
...
//MENU ITEM START (DESCENDING)
		...
		//File>HistoryChecked(History1)
			if (historyToolStripMenuItem->Checked == true) { //check for checked or unchecked
...
//BUTTONS START
    ...
    //OPERATORS START
		private: System::Void Airthmetic_Op(System::Object^ sender, System::EventArgs^ e) {
		//Operators(/, *, -, +, Mod, ^, %)
		...
		private: System::Void Trig_Op(System::Object^ sender, System::EventArgs^ e) {
    ...
    //OPERATOR END
		...
		//equals	
			...
			else if (iOperator == "Mod") { //Modular division
		...
		//decimal point
			if (!txtDisplay->Text->Contains(".")) { //adds only when given number doesnot contain decimal 
