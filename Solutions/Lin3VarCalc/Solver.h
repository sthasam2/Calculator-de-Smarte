...
public
	...
	protected:
	private:
		System::Windows::Forms::Button ^ solve3;
	...
	private:
		System::Windows::Forms::TextBox ^ textBoxZ3;

	private:
		System::Windows::Forms::TextBox ^ textBoxY3;

	private:
		System::Windows::Forms::TextBox ^ textBoxX3;

	private:
		System::Windows::Forms::Button ^ Reset3;
	...
	private:
		System::Windows::Forms::TextBox ^ textBoxD2;
	...
	private:
		System::Windows::Forms::Label ^ labelA1;

	private:
		System::Windows::Forms::TextBox ^ textBoxD1;
	...
	private:
		System::Windows::Forms::TextBox ^ textBoxD3;

	private:
		System::Windows::Forms::TextBox ^ textBoxC3;

	private:
		System::Windows::Forms::TextBox ^ textBoxB3;

	private:
		System::Windows::Forms::TextBox ^ textBoxA3;
...
#pragma endregion
	...
	private:
		System::Void Reset3_Click(System::Object ^ sender, System::EventArgs ^ e)
		{
			textBoxA1->Text = "";
			textBoxB1->Text = "";
			textBoxC1->Text = "";
	...
	private:
		System::Void textBoxA1_TextChanged(System::Object ^ sender, System::EventArgs ^ e)
		{
		}

	private:
		System::Void solve3_Click(System::Object ^ sender, System::EventArgs ^ e)
		{
			Solver::Height = 695;
